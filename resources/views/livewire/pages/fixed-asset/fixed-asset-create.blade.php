        ...
        <form wire:submit.prevent="save" class="space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <flux:input id="brand" wire:model.defer="brand" placeholder="Lenovo, HP, Sony, etc." />
                </div>
                ...
                <div>
                    ...
                    <flux:input id="supplier" wire:model.defer="supplier" placeholder="Supplier name" />
                </div>

                {{-- Assigned To --}}
                <div>
                    <flux:label for="assigned_to">Assigned To</flux:label>
                    <flux:input id="assigned_to" wire:model.defer="assigned_to" placeholder="Employee or department" />
                </div>

                {{-- Class --}}
                <div>
                    <flux:label for="class">Class (Employee)</flux:label>
                    <flux:input id="class" wire:model.defer="class" placeholder="Employee name" />
                </div>

                {{-- Location --}}
                <div>
                    <flux:label for="location">Location</flux:label>
                    <flux:input id="location" wire:model.defer="location" placeholder="Office or physical location" />
                </div>
                ...
                <div>
                    ...
                    <flux:input id="purchase_order_no" wire:model.defer="purchase_order_no" placeholder="PO Number" />
                </div>
