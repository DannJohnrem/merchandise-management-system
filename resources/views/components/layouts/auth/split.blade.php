        ...
        <div class="relative grid h-dvh flex-col items-center justify-center px-8 sm:px-0 lg:max-w-none lg:grid-cols-2 lg:px-0">
            ...
            <div
                class="relative hidden h-full flex-col p-10 text-white lg:flex
                       bg-cover bg-center dark:border-e dark:border-neutral-800"
            ...
            >
                ...
                <!-- LOGO -->
                <a href="{{ route('home') }}" class="relative z-20 flex items-center text-lg font-medium gap-3" wire:navigate>
