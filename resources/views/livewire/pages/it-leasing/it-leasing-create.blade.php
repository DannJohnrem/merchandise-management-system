    ...
    <div class="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 shadow rounded-lg p-6">
        ...
        <form wire:submit.prevent="save" class="space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    <flux:label for="category">Category <span class="text-red-400 ml-1">*</span></flux:label>
                ...
                <div>
                    <flux:label for="serial_number">Serial Number <span class="text-red-400 ml-1">*</span></flux:label>
                ...
                <div>
                    ...
                    <flux:input id="brand" wire:model.defer="brand" placeholder="Lenovo, HP, etc." />
                </div>
                ...
                <div>
                    ...
                    <flux:input id="assigned_to" wire:model.defer="assigned_to"
                        placeholder="Department or site" />
                </div>
